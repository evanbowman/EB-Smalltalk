...
operand : literal | variable | subexpression | block;
subexpression : OPEN_PAREN ws? expression ws? CLOSE_PAREN;
literal : pseudoVariable | number | charConstant | literalArray | string | symbol;
...
literalArrayRest : ws? ((literal | bareLiteralArray | bareSymbol) ws?)* CLOSE_PAREN;
